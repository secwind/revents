...
const validate = combineValidators({
    newPassword1: isRequired({message:'Plese enter a password'}),
    newPassword2: composeValidators(
      isRequired({message:'Plese confirm a password'}),
      matchesField('newPassword1')({message:'password ไม่ตรงกันกรุณาตรวจสอบ'}),
    )()
})
